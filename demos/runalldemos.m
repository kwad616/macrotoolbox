% RUNALLDEMOS  Runs all demos in macrotoolbox
%              To run single examples simply type 'scriptname' where
%              scriptname can be:
%
%              brock_mirman : Brock and Mirman model
%              endowment    : small open endowment economy
%              rbc          : real business cycle model (no employment)
%              huggett      : partial equilibrium of Huggett (1993) 
%              mendoza      : Mendoza (1991)
%              aiyagari     : Aiyagari (1993), general equilibrium

clear all; brock_mirman  % Brock and Mirman
